...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Контент-маркетолог в Толк" },
      { name: "description", content: "Специалист по маркетинговым коммуникациям с опытом в B2B, SaaS, AI, PropTech, Gaming, Blockchain, Digital services, B2C, Media" },
