...
const jobs: Job[] = [
  ...
  },
  {
    ...
    body: (
      <p className="text-muted-foreground">
        Контент-маркетинг, PR и образовательные проекты платформы: блог, email-рассылки, корпоративные соцсети, вебинары и партнёрские проекты. Квартальные аналитические отчёты для совета директоров, совместный маркетинг с партнёрами, PR-коммуникация — пресс-релизы, СМИ, материалы для спикеров. Организовала и провела 200+ вебинаров и образовательных событий, продюсировала видео- и email-курсы.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <p className="text-muted-foreground">
        Предпринимательский опыт: вместе с партнёром развивала агентство свадеб и мероприятий за границей. Отвечала за развитие продукта, клиентский сервис и маркетинг, стратегию продвижения, соцсети, рекламу, B2B-переговоры с международными партнёрами (EN). Организовала 320+ свадебных мероприятий в 17 странах мира.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <p className="text-muted-foreground">
        Прошла путь от журналиста до руководителя отдела маркетинга в одном из крупнейших региональных медиахолдингов. Была частью управляющей команды «Делового квартала» — участвовала в запуске сети журналов в городах-миллионниках: Челябинск, Новосибирск, Ростов-на-Дону, Красноярск.
      </p>
    ),
  },
];
...
const education = [
  ...
  {
    place: "Институт Международных Связей",
    what: "Связи с общественностью",
    note: "специалист · отлично",
  },
  { place: "УГТУ–УПИ (УрФУ)", what: "Менеджмент", note: "квалификация: менеджер · отлично" },
  {
    place: "Институт Международных Связей",
    what: "Переводчик в сфере профессиональной коммуникации",
        ...
        <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-3xl border border-border bg-background p-8 md:p-10 lg:col-span-2">
              ...
              <p className="mt-6 text-lg leading-relaxed text-foreground/75">
                Объясняю, пишу, редактирую, упаковываю и помогаю командам доносить идеи через
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl border border-border bg-background p-8">
              ...
              <p className="text-lg leading-relaxed text-foreground/85">
                ...
                привычка искать информацию, проверять факты, слышать тон и находить смыслы.
              </p>
            </div>
            <div className="rounded-3xl border border-border bg-background p-8">
              <div className="mb-3 text-sm font-medium uppercase tracking-wider text-muted-foreground">
              ...
              <p className="text-lg leading-relaxed text-foreground/85">
                ...
                командами и подрядчиками, разработчиками и креативными специалистами,
                топ-менеджерами и фаундерами — со всеми нахожу общий язык и легко осваиваю
                новый контекст.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-5">
            ...
            <div className="rounded-3xl border border-border bg-background p-8 md:col-span-3">
              ...
              <p className="text-lg leading-relaxed text-foreground/85">
                Работаю в международном стартапе для управдомов и
      ...
      <section id="motivation" className="scroll-mt-20 mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="rounded-3xl border border-border bg-card p-8 md:p-12">
          <p className="text-xl leading-relaxed text-foreground/90">
            Мне близки ценности Контура и интересен продукт. Думаю, что смогу здесь применить
            весь свой профессионализм и опыт, быстро стартовать в роли и эффективно решать
            задачи бизнеса. Среди моих экс-коллег есть те, кто сейчас или раньше работал в
            Контуре, и они будут рады меня рекомендовать.
          </p>
