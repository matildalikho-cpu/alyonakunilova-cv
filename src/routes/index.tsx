...
const projects: React.ReactNode[] = [
  ...
  <span>Редактор проекта «Код города» — книга о ДНК Екатеринбурга (2022)</span>,
