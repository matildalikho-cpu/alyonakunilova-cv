          ...
          <div className="grid gap-6">
            <div className="rounded-3xl border border-border bg-background p-8 md:p-10">
              <div className="space-y-6 text-lg leading-relaxed text-foreground/85 md:text-xl">
                <p>
                  <b>Более 15 лет я работаю в маркетинге, PR и коммуникациях — в B2B и B2C, с компаниями и проектами разного масштаба. У меня профильное образование и опыт работы с брендом, контентом, медиа, инфлюенсерами и селебрити, мероприятиями, партнёрствами, подрядчиками, рекламными и презентационными материалами, а также с коммуникациями, связанными с продажами и привлечением клиентов.&nbsp;Я была публичным спикером компании и участвовала в образовательных проектах.&nbsp;Я работала и в периоды роста, и во время кризисов — умею и развивать то, что работает, и перестраиваться, когда меняются рынок, условия и задачи. Быстро разбираюсь в новой теме, вижу картину целиком, нахожу слабые места и превращать разрозненные задачи в понятную рабочую систему, которая помогает доводить решения до результатов.</b>
                </p>
              </div>
            </div>
          </div>
