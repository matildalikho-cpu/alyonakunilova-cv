...
const jobs: Job[] = [
  ...
  },
  {
    ...
    body: (
      <p className="text-muted-foreground">
        Предпринимательский опыт: вместе с партнёром развивала агентство свадеб и мероприятий за границей. Отвечала за развитие продукта, клиентский сервис и маркетинг, стратегию продвижения, соцсети, рекламу, B2B-переговоры с международными партнёрами (EN). Организовала 320+ международных свадебных мероприятий в 17 странах мира.
      </p>
    ),
  },
  {
