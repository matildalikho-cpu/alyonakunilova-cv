          ...
          <div className="grid gap-6">
            <div className="rounded-3xl border border-border bg-background p-8 md:p-10">
              <div className="space-y-6 text-lg leading-relaxed text-foreground/85 md:text-xl">
                <p>
                  <b>Более 15 лет я работаю в маркетинге, PR и коммуникациях — в B2B и B2C, с компаниями и проектами разного масштаба. У меня профильное образование и опыт работы с брендом, контентом, медиа, инфлюенсерами и селебрити, мероприятиями, партнёрствами, подрядчиками, рекламными и презентационными материалами, а также с коммуникациями, связанными с продажами и привлечением клиентов.&nbsp;В моём опыте — люксовый ритейл, публичные выступления от лица компании и участие в образовательных проектах. Я работала и в периоды роста, и во время кризисов, поэтому хорошо знаю, как действовать, когда готовых решений нет, условия быстро меняются, а результат всё равно нужен.</b>
                </p>
                <p>
                  <span>Умею быстро разбираться в новой теме, видеть картину целиком, находить слабые места и превращать разрозненные задачи в понятную рабочую систему. Навожу операционный порядок и выстраиваю структуру, которая помогает не только придумать решение, но и довести его до реализации.</span>
                </p>
              </div>
            </div>
          </div>
